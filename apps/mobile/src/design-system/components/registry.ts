...
export const DESIGN_SYSTEM_COMPONENTS: DesignSystemComponent[] = [
  ...
  { name: "Input", module: "components/ui/primitives", status: "needs_redesign", notes: "Extract dedicated Input from login screens" },
  ...
  { name: "IconButton", module: "components/ui/primitives", status: "missing" },
