...
export const DESIGN_SYSTEM_COMPONENTS: DesignSystemComponent[] = [
  ...
  { name: "ProfileHeader", module: "design-system/components/ProfileHeader", status: "ready" },
  { name: "ProfileAccountCard", module: "design-system/components/ProfileAccountCard", status: "ready" },
  { name: "ProfileQuickActions", module: "design-system/components/ProfileQuickActions", status: "ready" },
  { name: "ProfileShoppingActivity", module: "design-system/components/ProfileShoppingActivity", status: "ready" },
  { name: "ProfileSavedData", module: "design-system/components/ProfileSavedData", status: "ready" },
  { name: "ProfileSupportSection", module: "design-system/components/ProfileSupportSection", status: "ready" },
  { name: "ProfileSettingsSection", module: "design-system/components/ProfileSettingsSection", status: "ready" },
  { name: "ProfileDiagnosticsSection", module: "design-system/components/ProfileDiagnosticsSection", status: "ready" },
  { name: "ProfileClosedAlphaCard", module: "design-system/components/ProfileClosedAlphaCard", status: "ready" },
  { name: "ProfileDangerSheet", module: "design-system/components/ProfileDangerSheet", status: "ready" },
  { name: "ProfileSkeleton", module: "design-system/components/ProfileSkeleton", status: "ready" },
