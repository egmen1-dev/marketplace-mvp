...
export function runRankingLab1000(): RankingLab1000Report {
...
export function getRankingLab1000Report(): RankingLab1000Report {
  if (!cachedReport) cachedReport = runRankingLab1000();
  return cachedReport;
}
...
export function getProductLabReport(productId: string) {
  const report = getRankingLab1000Report();
  return {
