...
function resolveGitCommit(): string {
  try {
    ...
    return CLOSED_ALPHA_RELEASE_012.gitCommit;
  }
}
...
export async function ensureClosedAlpha012ReleasePublished(input: PublishClosedAlphaInput = {}) {
  ...
  return {
    ...
    previousVersionCode: CLOSED_ALPHA_RELEASE_011.versionCode,
    downloadUrl: CLOSED_ALPHA_APK_DOWNLOAD_URL,
    firstSupportedRelease: true,
    minimumSupportedVersionCode: CLOSED_ALPHA_APK.versionCode,
    tester,
  };
}
