...
export const MARKETPLACE_SCREENS: MarketplaceScreenDefinition[] = [
  ...
  { id: "profile", name: "Profile", route: "(tabs)/profile", sourceFiles: ["apps/mobile/app/(tabs)/profile.tsx", "apps/mobile/src/features/profile/ProfileExperience.tsx", "apps/mobile/src/features/profile/useProfileData.ts"], journey: "shared" },
  ...
  { id: "settings", name: "Settings", route: "(tabs)/profile", sourceFiles: ["apps/mobile/app/(tabs)/profile.tsx", "apps/mobile/src/features/profile/ProfileExperience.tsx"], journey: "shared" },
  { id: "notifications", name: "Notifications", route: "profile", sourceFiles: ["apps/mobile/app/(tabs)/profile.tsx", "apps/mobile/src/design-system/components/ProfileSettingsSection.tsx"], journey: "shared" },
