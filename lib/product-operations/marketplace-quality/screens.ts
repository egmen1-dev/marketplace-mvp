...
export const MARKETPLACE_SCREENS: MarketplaceScreenDefinition[] = [
  ...
  { id: "catalog", name: "Catalog", route: "(tabs)/catalog", sourceFiles: ["apps/mobile/app/(tabs)/catalog.tsx"], journey: "buyer" },
  { id: "search", name: "Search", route: "catalog", sourceFiles: ["apps/mobile/app/(tabs)/catalog.tsx", "apps/mobile/src/components/ui/CommerceSearchBar.tsx"], journey: "buyer" },
  { id: "category", name: "Category", route: "catalog", sourceFiles: ["apps/mobile/app/(tabs)/catalog.tsx"], journey: "buyer" },
  { id: "product_card", name: "Product Card", route: "catalog", sourceFiles: ["apps/mobile/src/components/ui/ProductCard.tsx"], journey: "buyer" },
  { id: "product_details", name: "Product Details", route: "product/[id]", sourceFiles: ["apps/mobile/app/product/[id].tsx"], journey: "buyer" },
  { id: "favorites", name: "Favorites", route: "(tabs)/favorites", sourceFiles: ["apps/mobile/app/(tabs)/favorites.tsx"], journey: "buyer" },
  { id: "cart", name: "Cart", route: "cart", sourceFiles: ["apps/mobile/app/cart.tsx"], journey: "buyer" },
  { id: "checkout", name: "Checkout", route: "checkout", sourceFiles: ["apps/mobile/app/checkout.tsx"], journey: "buyer" },
  ...
  { id: "seller_product", name: "Seller Product", route: "product/[id]", sourceFiles: ["apps/mobile/app/product/[id].tsx"], journey: "seller" },
