...
const trustItems = [
  {
    ...
    text: "Оплата с защитой сделки — спокойно для покупателя и продавца.",
  },
  {
    icon: Truck,
    title: "Доставка СДЭК",
    text: "Пункты выдачи и курьер по всей стране.",
  },
  {
    icon: Package,
    title: "Большой выбор",
    text: "Товары от магазинов и частных продавцов в одном каталоге.",
  },
] as const;
