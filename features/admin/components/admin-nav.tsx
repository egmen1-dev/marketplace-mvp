...
const NAV_ITEMS = [
  ...
  {
    href: ROUTES.ADMIN_RELEASE,
    label: "Release",
    icon: Rocket,
    match: (pathname: string) => pathname.startsWith(ROUTES.ADMIN_RELEASE),
  },
  {
  ...
  },
  {
    ...
    icon: LineChart,
    match: (pathname: string) =>
      pathname === ROUTES.ADMIN_RANKING ||
      (pathname.startsWith(`${ROUTES.ADMIN_RANKING}/`) &&
        !pathname.startsWith(ROUTES.ADMIN_RANKING_LAB)),
  },
  {
    href: ROUTES.ADMIN_RANKING_LAB,
    label: "Ranking Lab",
    icon: LineChart,
