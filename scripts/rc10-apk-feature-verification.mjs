...
const symbolGroups = {
  ...
  epic158_2_sellerUxSimplify: [
    { name: "lotCreateCopy", pattern: "Вы начали создавать ЛОТ" },
    { name: "lotCreateStickyFooter", pattern: "LotCreateStickyFooter" },
    { name: "ctaPrimary", pattern: "ctaPrimary" },
    { name: "humanPublishError", pattern: "Не получилось опубликовать ЛОТ" },
  ],
  epic158_3_previewUpdate: [
    { name: "previewTitle", pattern: "Проверьте ЛОТ" },
    { name: "previewFooter", pattern: "LotCreatePreviewFooter" },
    { name: "updateForegroundRefresh", pattern: "AppState.addEventListener" },
    { name: "profileUpdateBadge", pattern: "Обновление доступно" },
  ...
  epic159_sellerBetaAcceptance: [
    ...
    { name: "successTitle", pattern: "ЛОТ опубликован" },
    { name: "successBody", pattern: "Ваш ЛОТ теперь виден покупателям" },
    { name: "createAnother", pattern: "Создать ещё один" },
  ],
  epic152_sellerLoop: [
