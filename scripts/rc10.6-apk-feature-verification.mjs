#!/usr/bin/env node
/** RC10.6 APK forensics — PR #198 photo/submit/diagnostics fix symbols. */
import { createHash } from "node:crypto";
import { execFileSync } from "node:child_process";
import { mkdirSync, readFileSync, statSync, writeFileSync } from "node:fs";
import { resolve } from "node:path";

const apkPath = process.argv[2] ?? "artifacts/closed-beta-rc10.6/lot_android_closed_beta_0.1.15_beta.7.apk";
const OUT = resolve("artifacts/closed-beta-rc10.6/apk-feature-verification.json");
const SILENT_FAILURE_OUT = resolve("artifacts/closed-beta-rc10.6/silent-failure-invariant.json");
const SIGNER_OUT = resolve("artifacts/closed-beta-rc10.6/signer-verification.json");
...
const identityChecks = [
  { name: "versionName", ok: identity.versionName === "0.1.15-beta.7", expected: "0.1.15-beta.7", actual: identity.versionName },
  { name: "versionCode", ok: identity.versionCode === "22", expected: "22", actual: identity.versionCode },
  ...
  { name: "rc10_6Label", ok: bundleContains("RC10.6"), expected: "RC10.6 in bundle", actual: bundleContains("RC10.6") ? "present" : "missing" },
...
const signerReport = {
  ...
  rc10_5SignerSha256: "fac61745dc0903786fb9ede62a962b399f7348f0bb6f899b8332667591033b9c",
  compatibleWithCode21: true,
  verdict: signerSha256 === "fac61745dc0903786fb9ede62a962b399f7348f0bb6f899b8332667591033b9c" ? "PASS" : "FAIL",
};

mkdirSync(resolve("artifacts/closed-beta-rc10.6"), { recursive: true });
...
console.log(JSON.stringify({ verdict: report.verdict, failed: report.failed, identity, signerSha256, silentFailure: silentFailureReport.verdict }, null, 2));
