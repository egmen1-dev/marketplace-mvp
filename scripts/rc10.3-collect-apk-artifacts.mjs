#!/usr/bin/env node
/** Collect APK artifacts for RC10.3 build (P0.1 dynamic characteristics). */
import { createHash } from "node:crypto";
import { execFileSync } from "node:child_process";
import { mkdirSync, readFileSync, statSync, writeFileSync } from "node:fs";
import { resolve } from "node:path";

const ARTIFACT_DIR = resolve("artifacts/closed-beta-rc10.3");
const APK_NAME = "lot_android_closed_beta_0.1.15_beta.4.apk";
...
const manifest = {
  ...
  artifact: {
    fileName: APK_NAME,
    path: `artifacts/closed-beta-rc10.3/${APK_NAME}`,
    downloadUrl: `https://raw.githubusercontent.com/egmen1-dev/marketplace-mvp/main/artifacts/closed-beta-rc10.3/${APK_NAME}`,
    sha256,
    sizeBytes,
  },
  android: {
  ...
  embeddedMetadata: {
    ...
    previousRelease: "RC10.2 0.1.15-beta.3 (code 18)",
  },
  buildNotes: {
    release: "RC10.3 — P0.1 dynamic LOT category characteristics",
    previousRelease: "RC10.2 0.1.15-beta.3 (code 18)",
  },
};
