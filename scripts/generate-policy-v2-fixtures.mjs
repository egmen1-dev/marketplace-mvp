...
const base = [
  ...
  { id: "contact-in-image-url", tags: ["manual"], expected: "MANUAL_REVIEW", input: { title: "Стол", imageUrls: ["https://t.me/seller123/photo.jpg"] } },
  { id: "qr-in-image", tags: ["manual"], expected: "MANUAL_REVIEW", input: { title: "Книга", imageUrls: ["/qr-code-promo.png"] } },
