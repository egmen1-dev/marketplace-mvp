#!/usr/bin/env node
/** Publish RC9.1 to MRP via staging admin API. */
...
const OUT = resolve("artifacts/closed-beta-rc9.1/mrp-publish-report.json");

const manifestPath = resolve("artifacts/closed-beta-rc9.1/build-manifest.json");
...
const RELEASE = {
  ...
  channel: "BETA",
  releaseNotes: [
    "Closed Beta RC9.1 — EPIC 157 UX Polish + EPIC 158 Seller LOT Creation",
    ...
    "Upgrade path: RC3–RC8 (code 7-13) → RC9.1 (code 14)",
  ].join("\n"),
