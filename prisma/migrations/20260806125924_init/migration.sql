...
-- CreateEnum
CREATE TYPE "DeliveryProvider" AS ENUM ('CDEK', 'PICKUP', 'OTHER');

-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('PENDING', 'CREATED', 'IN_TRANSIT', 'DELIVERED', 'RETURNED', 'CANCELLED');
...
CREATE TABLE "deliveries" (
    "id" TEXT NOT NULL,
    "orderId" TEXT NOT NULL,
    "provider" "DeliveryProvider" NOT NULL DEFAULT 'CDEK',
...
-- CreateIndex
CREATE INDEX "deliveries_provider_idx" ON "deliveries"("provider");
